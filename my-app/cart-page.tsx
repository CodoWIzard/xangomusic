        ...
        <div className="text-center">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-stone-200 p-12">
            <div className="text-center">
              ...
              <p className="text-stone-600 mb-6">Add some records to get started!</p>
              <a 
                href="/" 
      ...
      <div className="bg-white rounded-lg shadow-sm border border-stone-200">
        <div className="p-6">
          {state.items.map((item) => (
            <div key={item.id} className="flex items-center py-4 border-b border-stone-200 last:border-b-0">
        ...
        <div className="border-t border-stone-200 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-2xl font-bold text-stone-900">${state.total.toFixed(2)}</span>
          </div>
          
          <div className="bg-stone-50 rounded-lg p-4 mb-4">
            <p className="text-stone-600 text-sm">
              This is a demo store. No actual payment processing is available.
              Please visit our "How to Order" page for ordering instructions.
            </p>
          </div>
