    ...
    <footer className="bg-stone-900 text-white mt-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Vinyl Vault</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-stone-300">
              ...
              <li><a href="/how-to-order" className="hover:text-white transition-colors">How to Order</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-stone-300 hover:text-white transition-colors">Facebook</a>
              <a href="#" className="text-stone-300 hover:text-white transition-colors">Instagram</a>
            </div>
          </div>
        </div>
        
        <div className="border-t border-stone-800 mt-8 pt-8 text-center text-stone-400">
          <p>&copy; 2024 Vinyl Vault. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
