...
export default function NewReleasesPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-4">New Releases</h1>
        <p className="text-stone-600 mb-6">
          Discover the latest additions to our vinyl collection, organized by
      ...
      {Object.keys(recordsByGenre).length === 0 ? (
        <div className="text-center py-12">
          <p className="text-stone-500 text-lg">
            No new releases found in the last {selectedPeriod} days.
          </p>
        </div>
      ) : (
      ...
      <div className="mt-12 bg-white rounded-lg shadow-sm border border-stone-200 p-6">
        ...
        <div className="text-stone-600 space-y-2">
          <p>
            Our new releases section features the latest vinyl records added to
            our collection.
          </p>
          <p>
            We regularly update our inventory with rare finds, reissues, and
            brand new pressings from artists around the world.
          </p>
          <p>
            Check back frequently to discover new additions to your collection!
          </p>
        </div>
      </div>
    </div>
