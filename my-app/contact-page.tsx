export default function ContactPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-stone-900 mb-8">Contact Us</h1>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <section className="bg-white rounded-lg shadow-sm border border-stone-200 p-6">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">Get in Touch</h2>
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-stone-900">Store Location</h3>
                  <p className="text-stone-600">123 Music Row<br />Nashville, TN 37203</p>
                  <p className="text-stone-500 text-sm">Visit by appointment only</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-sm border border-stone-200 p-6">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">Store Hours</h2>
        ...
        <div className="space-y-6">
          <section className="bg-white rounded-lg shadow-sm border border-stone-200 p-6">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">Send us a Message</h2>
          ...
          <section className="bg-white rounded-lg shadow-sm border border-stone-200 p-6">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">Map Placeholder</h2>
